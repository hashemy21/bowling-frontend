...
export default class Scorecard extends Component {
  ...
  render () {
    const {cumulativeScores, totalScore, playerName} = this.props
    return (
        ...
        <table id='table' className='Scorecard' cellPadding='1' cellSpacing='0'>
          <tbody>
            ...
            <tr>
              ...
              <td id='player-name' className='Player' colSpan='6'>{playerName}</td>
            ...
            <tr>
              ...
              <td id='player-name' colSpan='6'></td>
